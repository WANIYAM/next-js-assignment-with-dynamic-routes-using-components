...
function Nav(){
    return(
        <div>
            <header className="bg-sky-400 text-white w-full " >
            <nav className="flex list-none justify-center gap-16 h-20 items-center text-2xl">
                <li className=" ease duration-300 hover:text-red-700  cursor-pointer">
                  <Link href={"/"}>  Home</Link></li>
                <li className=" ease duration-300 hover:text-yellow-400  cursor-pointer">
                <Link href={"/about"}>  About</Link></li>
                <li className=" ease duration-300 hover:text-sky-600 cursor-pointer">
